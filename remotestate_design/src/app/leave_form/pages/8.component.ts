...
@Component({
    ...
    template: `
        <div class="page_footer">
            <a routerLink="/remotestate/leave/seven_page"><button type="button" class="back_button">Back</button></a>
            <a routerLink="/remotestate/leave"><button type="button" class="leave_page_button">Leave Form</button></a>
            <a routerLink="/remotestate/leave/nine_page"><button type="button" class="next_button">Next</button></a>
        </div>
...
export class eigthpagecomponent {}